...
<div class="row">
    <div class="col-lg-3 col-md-6">
        ...
        <div class="col-lg-3 col-md-6">
            ...
            <div class="col-xs-9 text-right">
                <div class="huge">
                    <?php echo $this->rental_model->get_data('kostumer')->num_rows(); ?>
                </div>
    ...
    <div class="col-xs-9 text-right">
        <div class="huge">
        <?php echo $this->rental_model->get_data('transaksi')->num_rows(); ?>
        </div>
...
<div class="col-xs-9 text-right">
<div class="huge">
<?php echo $this->rental_model->edit_data(array('transaksi_status'=>1),'transaksi')->num_rows(); ?>
</div>
...
<span class="badge"><?php if($m->status_mobil == 1){echo "Tersedia";}else{echo "Dirental";} ?></span>
<i class="glyphicon glyphiconuser"></i> <?php echo $m->merk_mobil; ?>
</a>
<?php } ?>
</div>
...
<a href="#" class="list-group-item">
<span class="badge"><?php echo $k->jk_kostumer ?></span>
<i class="glyphicon glyphicon-user"></i> <?php echo $k->nama_kostumer; ?>
</a>
<?php } ?>
</div>
<div class="text-right">
